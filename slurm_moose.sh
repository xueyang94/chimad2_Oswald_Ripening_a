#!/bin/sh
#SBATCH --job-name=restart_2benchmark          #Job name
...
srun --mpi=pmi2 /home/wuxueyang/projects/moose/modules/phase_field/phase_field-opt -i /ufrc/michael.tonks/wuxueyang/restart_2benchmark/periodic_square.i
